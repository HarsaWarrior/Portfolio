...
const DATA = {
  navbar: [
    ...
    { href: "/Harsh_Resume.pdf", icon: PencilIcon, label: "Resume" },
  ],
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/HarsaWarrior",
        icon: Icons.github,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/harshpatil31/",
        icon: Icons.linkedin,
      },
      X: {
        name: "X",
        url: "https://x.com/Harsawarrior",
        icon: Icons.x,
      },
      email: {
        name: "Send Email",
        url: "mailto:harsh3152002@gmail.com",
        icon: Icons.email,
      },
    },
  },
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <div className="size-12 rounded-full flex justify-center items-center">
                            {mounted &&
                              (theme === "light" ? (
                                <Moon className="size-4 w-5 h-5" onClick={() => setTheme("dark")} />
                              ) : (
                                <Sun className="size-4 w-5 h-5" onClick={() => setTheme("light")} />
                              ))}
                        </div>
                    </TooltipTrigger>
                    <TooltipContent>
