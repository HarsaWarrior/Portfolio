...
const workExperience: WorkExperienceItem[] = [
  {
    ...
    description: [
      ...
      "Integrated Spring Security with JWT & RBAC, securing 100% of API endpoints and blocking unauthorized access attempts during internal audits.",
  ...
  },
  {
    ...
    description: [
      "Completed 6-month intensive training in web development, mastering core technologies including JavaScript, Java, React.js, Spring, Spring Boot and version control with Git.",
      "Designed 3+ internal mini-projects using Spring Boot and React.js, simulating real-world user flows like authentication, CRUD operations"
    ]
  }
];
